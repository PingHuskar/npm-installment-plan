const lastday = require("./src/lastday");
const daysDifference = require("./src/daysDifference");
const round = require("./src/round");
const getThisPayment = require("./src/getThisPayment");

const monthsInAYear = require("./src/monthsInAYear");
const daysInAYear = require("./src/daysInAYear")

const CalculateInstallmentPlan = require("./src/CalculateInstallmentPlan")
const CalculateInstallmentPlan_DE = require("./src/CalculateInstallmentPlan_DE")
